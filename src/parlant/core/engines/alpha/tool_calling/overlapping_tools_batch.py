...
class OverlappingToolsBatch(ToolCallBatch):
    ...
    def _should_retry_on_exception(self, exc: Exception) -> bool:
        ...
        - LLM output format errors (JSONDecodeError, ValueError from jsonfinder,
          ValidationError for OverlappingToolsBatchSchema): Random LLM errors, retry may succeed
        ...
        if is_llm_output_format_error(exc, llm_output_schema_name="OverlappingToolsBatchSchema"):
            return True
